export const jetee = [
  ...
  "happened on the main jetty at Dulles,",
  "the Washington DC airport,",
  "sometime before",
  "the outbreak of postmodernism.",
  "Dulles. Sunday.",
  ...
  "Once again the main jetty at Dulles,",
