...
BASE_POOL_PATH = "/Volumes/homes/jbe/never-forget"
...
BASE_POOL_PATH = "/Volumes/homes/jbe/never-forget"
# BASE_POOL_PATH = "/Volumes/homes/jbe/never_forget/never-forget-pooling/_ref/res-crawl"

img_paths = glob(f"{BASE_POOL_PATH}/**/*.png", recursive=True)
print("wut")
print(len(img_paths))
